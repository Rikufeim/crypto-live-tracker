    ...
    const features = [
        {
            ...
            description:
                "Track every price movement with institutional-grade precision and advanced charting tools.",
        ...
        },
        {
            ...
            description:
                "Leverage our proprietary AI models to identify market cycles and emerging trends early.",
        ...
        },
        {
            ...
            description:
                "Watch our pro traders breaking down the markets live on YouTube and get alpha direct.",
        ...
        },
        {
            ...
            description:
                "Connect to every major exchange through our unified liquidity gateway for instant execution.",
        ...
        <div className="relative z-20 mx-auto max-w-7xl py-10 lg:py-40">
            <div className="px-8">
                ...
                <p className="mx-auto my-4 max-w-2xl text-center text-sm font-normal text-neutral-500 lg:text-base dark:text-neutral-300">
                    From institutional market tracking to AI-driven trend predictions,
                    LiveTrack provides the tools you need to stay ahead of the curve.
                </p>
            </div>
...
export const SkeletonTwo = () => {
    const images = [
        "https://images.unsplash.com/photo-1621761191319-c6fb62004040?q=80&w=3387&auto=format&fit=crop",
        "https://images.unsplash.com/photo-1639710339852-514d3ec1761b?q=80&w=3540&auto=format&fit=crop",
        "https://images.unsplash.com/photo-1631603090989-4bc78308355a?q=80&w=3387&auto=format&fit=crop",
        "https://images.unsplash.com/photo-1634704784915-aacf363b021f?q=80&w=3540&auto=format&fit=crop",
        "https://images.unsplash.com/photo-1639322537231-2f206e06af84?q=80&w=3387&auto=format&fit=crop",
    ];
